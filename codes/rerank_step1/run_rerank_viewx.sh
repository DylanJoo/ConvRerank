...
MODEL_SIZE=base
CKPT=1100000
INPUT_FILE=convrerank/rerank_step1/input/cast20.canard.train.viewx.rerank.txt
TARGET_FILE=convrerank/true.txt
OUTPUT_FILE=convrerank/rerank_step1/output/cast20.canard.train.viewx.rerank.txt
