...
for view in singleview0 singleview1 reverseview;do
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.cqe.trec \
        --scores monot5-probs/ablation_views/$view.probs \
...
for topk in t3 t10 t20 t30 j20;do
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.cqe.trec \
        --scores monot5-probs/cast2020.eval.cqe.conv.rerank.$topk.txt.probs \
...
for first_stage in t5-cqe t5-dpr;do
    ...
    python3 tools/rerank_runs.py \
        ...
        --scores monot5-probs/ablation_firststage/cast2020.eval.$first_stage.conv.rerank.txt.probs \
    ...
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.$first_stage.trec \
        --scores monot5-probs/ablation_firststage/cast2020.eval.$first_stage.rerank.txt.probs \
...
for first_stage in t5-cqe t5-dpr;do
    ...
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.$first_stage.trec \
        --scores monot5-probs/ablation_firststage/cast2020.eval.$first_stage.zs.rerank.txt.probs \
...
for model_size in large 3B;do
    ...
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.cqe.trec \
        --scores monot5-probs/ablation_$model_size/cast2020.eval.cqe.conv.rerank.txt.probs \
    ...
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.cqe.trec \
        --scores monot5-probs/ablation_$model_size/cast2020.eval.cqe.rerank.txt.probs \
...
for warmup in from10k from0k;do
    python3 tools/rerank_runs.py \
        --baseline runs/cast2020/cast2020.eval.cqe.trec \
        --scores monot5-probs/ablation_warmup/cast2020.eval.cqe.conv.rerank.$warmup.txt.probs \
