...
python3 tools/rerank_runs.py \
    --baseline runs/cast2019/cast2019.eval.cqe.trec \
    --scores monot5-probs/rerank_cast2019/ablation_zeroshot/cast2019.eval.cqe.zs.rerank.txt.probs \
...
python3 tools/rerank_runs.py \
    --baseline runs/cast2019/cast2019.eval.cqe.trec \
    --scores monot5-probs/rerank_cast2019/ablation_window8/cast2019.eval.cqe.conv.rerank.t20.txt.probs \
    --reranked runs/cast2019/cast2019.eval.cqe.conv.rerank.window8.trec \
    --topk 1000 \
    --prefix conv-monot5 
