...
#   --n 30 \
#
# # ablation 2: hard negative from view disagreement reverse
# python3 tools/construct_convir_dataset.py \
#   --topic data/canard/train.jsonl \
#   --collections /tmp2/jhju/datasets/cast2020/ \
#   --run0 runs/cast20.canard.train.view1.monot5.top1000.trec \
#   --run1 runs/cast20.canard.train.view0.monot5.top1000.trec \
#   --output data/canard4ir/canard4ir.train.convrerank.rev.txt \
#   --topk_pool 200 \
#   --topk_positive 3 \
#   --n 30 \

# ablation 3: hard negative from view disagreement set
python3 tools/construct_convir_dataset_dev.py \
  --topic data/canard/train.jsonl \
  --collections /tmp2/jhju/datasets/cast2020/ \
  --run0 runs/cast20.canard.train.view0.monot5.top1000.trec \
  --run1 runs/cast20.canard.train.view1.monot5.top1000.trec \
  --output data/canard4ir/canard4ir.train.convrerank.dev.txt \
  --topk_pool 200 \
  --topk_sample 3 \
  --n 30 \
